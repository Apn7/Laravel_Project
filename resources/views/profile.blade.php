        ...
        <div class="col-md-4 text-center scrollable-container">
            ...
            <div class="card profile-card">
                <div class="card-body text-center">
                    ...
                    @if (Auth::id() == $user->id)
                        <form action="{{ route('uploaddp') }}" method="post" enctype="multipart/form-data" class="upload-dp-form mb-3">
                            @csrf
                    ...
                    @if (Auth::id() == $user->id)
                        <a href="{{ route('editProfileView', ['username' => $user->username]) }}" class="btn btn-edit-profile mt-3">Edit Profile</a>
                    @endif
                </div>
            </div>
        </div>
